...
-- local event = '{"data":[{"dt":"evt","pr":{"$ct":'..osnow..',"$tz":'..time_zone..',"$sid":'..sid..',"$url":"'..url..'","$eid":"广告曝光","_项目id":"'..projectid..'","_媒体id":"'..mediaid..'","_广告位id":"'..placementid..'","_创意id":"'..creativeid..'"}},{"dt":"ss","pr":{"$ct":'..osnow..',"$sid":'..sid..',"$tz":'..time_zone..',"$cn":"js","$vn":"2.0","$url":"'..url..'"}}],"sln":"itn","pl":"js","sdk":"zg_adver","sdkv":"2.0","owner":"zg","ut":"'..ut..'","tz":'..time_zone..',"debug":'..debug..',"ak":"'..appkey..'","usr":{"did":"'..did..'"}}';
local event = '{"data":[{"dt":"evt","pr":{"$ct":'..osnow..',"$tz":'..time_zone..',"$sid":'..sid..',"$url":"'..url..'","$eid":"广告曝光","_项目id":"'..projectid..'","_媒体id":"'..mediaid..'","_广告位id":"'..placementid..'","_创意id":"'..creativeid..'","$utm_source":"'..utm_source..'","$utm_medium":"'..utm_medium..'","$utm_campaign":"'..utm_campaign..'","$utm_content":"'..utm_content..'","$utm_term":"'..utm_term..'"}},{"dt":"ss","pr":{"$ct":'..osnow..',"$sid":'..sid..',"$tz":'..time_zone..',"$cn":"js","$vn":"2.0","$url":"'..url..'","$utm_source":"'..utm_source..'","$utm_medium":"'..utm_medium..'","$utm_campaign":"'..utm_campaign..'","$utm_content":"'..utm_content..'","$utm_term":"'..utm_term..'"}}],"sln":"itn","pl":"js","sdk":"zg_adver","sdkv":"2.0","owner":"zg","ut":"'..ut..'","tz":'..time_zone..',"debug":'..debug..',"ak":"'..appkey..'","usr":{"did":"'..did..'"}}';
