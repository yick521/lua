...
local projectid = args['projectid'];
local mediaid = args['mediaid'];
local placementid = args['placementid'];
local creativeid = args['creativeid'];
...
--重定向不传参
local r = '{"data":{},"return_message":"'..return_message..'"}';
